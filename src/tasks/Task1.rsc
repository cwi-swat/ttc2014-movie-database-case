...
IMDB createPositive(int i) =
	...
	when movies := ( j: movie("m<j>", toReal(j), 2013) | j <- [10*i..10*i+5] ),
		 ...
		 groups := {},
		 stars := {<10*i, 10*i>, <10*i+1, 10*i>, <10*i+2, 10*i>, <10*i+3, 10*i>,
		         <10*i, 10*i+1>, <10*i+1, 10*i+1>, <10*i+2, 10*i+1>, <10*i+3, 10*i+1>,
		         <10*i+1, 10*i+2>, <10*i+2, 10*i+2>, <10*i+3, 10*i+2>,
		         <10*i+1, 10*i+3>, <10*i+2, 10*i+3>, <10*i+3, 10*i+3>, <10*i+4, 10*i+3>,
		         <10*i+1, 10*i+4>, <10*i+2, 10*i+4>, <10*i+3, 10*i+4>, <10*i+4, 10*i+4>};
...
IMDB createNegative(int i) =
	...
	when movies := (j: movie("m<j>", toReal(j), 2013) | j <- [10*i+5..10*i+10] ),
		 ...
		 groups := {},
		 stars := {<10*i+5, 10*i+5>, <10*i+6, 10*i+5>,
		         <10*i+5, 10*i+6>, <10*i+6, 10*i+6>, <10*i+7, 10*i+6>,
		         <10*i+6, 10*i+7>, <10*i+7, 10*i+7>, <10*i+8, 10*i+7>,
		         <10*i+7, 10*i+8>, <10*i+8, 10*i+8>, <10*i+9, 10*i+8>,
		         <10*i+8, 10*i+9>, <10*i+9, 10*i+9>};
